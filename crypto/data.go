...
// 	packet, err := encryptFunc(packet, s.sendKey, s.sendCounter, plaintext, nil)
// 	if err != nil {
// 		return nil, err
// 	}
...
// 	plaintext, err := decryptFunc(nil, s.recvKey, recvCounter, packet, nil)
// 	if err != nil {
// 		return nil, err
// 	}
...
// 	ephemSecret, err := dhFunc(s.ephemPriv, s.theirEphemPub)
// 	if err != nil {
// 		return err
// 	}
// 	staticSecret, err := dhFunc(s.staticPriv, s.theirStaticPub)
// 	if err != nil {
// 		return err
// 	}
// 	key, err := hashFunc(append(ephemSecret, staticSecret...))
// 	if err != nil {
// 		return err
// 	}

// 	keys, err := deriveKeys(key, sendIndex, 1)
// 	if err != nil {
// 		return err
// 	}
// 	s.sendKey = keys[0]
// 	keys, err = deriveKeys(key, recvIndex, 1)
// 	if err != nil {
// 		return err
// 	}
// 	s.recvKey = keys[0]
